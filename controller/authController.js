...
exports.login = catchAsync(async (req, res, next) => {
  ...
  //2 check if user exists amd password is correct
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `Forgot your password? click here  ${resetUrl} to reset it.\n if not ignore this mail`;
  ...
  try {
    ...
    return next(
      new AppError(
        'There was an error sending the email! try again laters',
        500
      )
    );
  }
